...
var $author$project$Clase4$altura = function (arbol) {
	if (arbol.$ === 'Empty') {
		...
		return 1 + A2(
			...
			$author$project$Clase4$altura(der));
	}
};
		...
		while (true) {
			if (arbol.$ === 'Empty') {
				...
				if (_Utils_eq(v, valor)) {
					...
					var _v1 = A2($author$project$Clase4$buscar, valor, left);
					if (_v1.$ === 'Just') {
		...
		while (true) {
			if (arbol.$ === 'Empty') {
				...
				if (predicado(v)) {
					...
					var _v1 = A2($author$project$Clase4$buscarPor, predicado, left);
					if (_v1.$ === 'Just') {
						var valor = _v1.a;
...
var $author$project$Clase4$contiene = F2(
	function (valor, arbol) {
		if (arbol.$ === 'Empty') {
			...
			var left = arbol.b;
			var right = arbol.c;
			return _Utils_eq(v, valor) ? true : (A2($author$project$Clase4$contiene, valor, left) ? true : (A2($author$project$Clase4$contiene, valor, right) ? true : false));
		}
	});
	...
	if (arbol.$ === 'Empty') {
		...
		if ((arbol.b.$ === 'Empty') && (arbol.c.$ === 'Empty')) {
			...
			var _v3 = _Utils_Tuple2(
				$author$project$Clase4$encontrarMaximo(left),
				$author$project$Clase4$encontrarMaximo(right));
			if (_v3.a.$ === 'Nothing') {
				if (_v3.b.$ === 'Nothing') {
					var _v4 = _v3.a;
					var _v5 = _v3.b;
...
var $author$project$Clase4$encontrarMinimo = function (arbol) {
	if (arbol.$ === 'Empty') {
		...
		if ((arbol.b.$ === 'Empty') && (arbol.c.$ === 'Empty')) {
			...
			var right = arbol.c;
			var _v3 = _Utils_Tuple2(
				$author$project$Clase4$encontrarMinimo(left),
				$author$project$Clase4$encontrarMinimo(right));
			if (_v3.a.$ === 'Nothing') {
				if (_v3.b.$ === 'Nothing') {
					var _v4 = _v3.a;
					var _v5 = _v3.b;
	...
	if (arbol.$ === 'Empty') {
		...
		if ((arbol.b.$ === 'Empty') && (arbol.c.$ === 'Empty')) {
			...
			return A2(
				...
				A2(
					$elm$core$Basics$max,
					$author$project$Clase4$maximo(left),
					$author$project$Clase4$maximo(right)));
		}
	}
};
	...
	if (arbol.$ === 'Empty') {
		...
		if ((arbol.b.$ === 'Empty') && (arbol.c.$ === 'Empty')) {
			...
			return A2(
				...
				A2(
					$elm$core$Basics$min,
					$author$project$Clase4$minimo(left),
					$author$project$Clase4$minimo(right)));
		}
	}
};
...
var $author$project$Clase4$sumarArbol = function (arbol) {
	if (arbol.$ === 'Empty') {
		...
		var left = arbol.b;
		var right = arbol.c;
		return (valor + $author$project$Clase4$sumarArbol(left)) + $author$project$Clase4$sumarArbol(right);
	}
};
var $author$project$Clase4$tamano = function (arbol) {
	if (arbol.$ === 'Empty') {
		return 0;
	} else {
		var left = arbol.b;
		var right = arbol.c;
		return (1 + $author$project$Clase4$tamano(left)) + $author$project$Clase4$tamano(right);
	}
};
				...
				[
					...
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							0,
							$author$project$Clase4$tamano($author$project$Clase4$Empty));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'4. Tamaño - hoja',
					...
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							3,
							$author$project$Clase4$tamano($author$project$Clase4$arbolPequeno));
					}),
					A2(
					$elm_explorations$test$Test$test,
